...
export interface Store<S = any, A extends Action = AnyAction> {
     ...
     */
    replaceReducer<NewState = S, NewActions extends A = A>(nextReducer: Reducer<NewState, NewActions>): Store<NewState, NewActions>;
    /**
...
export interface StoreCreator {
    ...
    <S, A extends Action, Ext, StateExt>(reducer: Reducer<S, A>, preloadedState?: PreloadedState<S>, enhancer?: StoreEnhancer<Ext>): Store<S & StateExt, A> & Ext;
}
/**
...
export declare type StoreEnhancerStoreCreator<Ext = {}, StateExt = {}> = <S = any, A extends Action = AnyAction>(reducer: Reducer<S, A>, preloadedState?: PreloadedState<S>) => Store<S & StateExt, A> & Ext;
export {};
