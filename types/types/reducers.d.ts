 ...
 */
export declare type StateFromReducersMapObject<M> = M extends ReducersMapObject<any, any> ? {
 ...
 * @template M Object map of reducers as provided to `combineReducers(map: M)`.
 */
export declare type ActionFromReducersMapObject<M> = M extends ReducersMapObject<any, any> ? ActionFromReducer<ReducerFromReducersMapObject<M>> : never;
