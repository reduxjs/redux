...
In the end, Redux is just a tool.  It's a great tool, and there're some great reasons to use it, but there're also reasons you might not want to use it.   Make informed decisions about your tools, and understand the tradeoffs involved in each decision.
