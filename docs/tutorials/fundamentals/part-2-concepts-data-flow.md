...
In [Part 1](./part-1-overview.md), we saw a small example of what a working Redux app looks like and
...
Now, let's see how those pieces work together as we start building a new Redux application in [Part 3](./part-3-state-reducers-actions).
