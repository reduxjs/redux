...
- It is up to you to choose the state format. You can use plain objects or something like [Immer](https://github.com/immerjs/immer). If you're not sure, start with plain objects.
