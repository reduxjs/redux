...
Recall as [mentioned previously](usagewithreact.md#designing-other-components), both the presentation and logic for the `AddTodo` component are mixed into a single definition.
...
Read the [complete source code for this tutorial](exampletodolist.md) to better internalize the knowledge you have gained. Then, head straight to the [advanced tutorial](../advanced/) to learn how to handle network requests and routing!
