...
const OtherLibraries = () => (
  <Container className="rowContainer">
    <h2 style={{ margin: 0 }}>Other Libraries from the Redux Team</h2>
...
const DocsSurvey = () => (
  <Block layout="twoColumn" className="docsSurvey rowContainer">
    {[
      {
        content:
          "We're planning a revamp of the Redux docs content.  Please help us make the docs better by **[filling out this survey](https://docs.google.com/forms/d/e/1FAIpQLSfzIkY3fXZ8PrQKScYMK0YoEgALfAK2qQ0mOj1_ibKv2qDTuQ/viewform)**, so we can determine what changes would help the most.  Thanks!",
