          ...
          <div className="container">
            <div className="row">
              <div className={classnames('col col--3', styles.feature)}>
                ...
                <h3 className={styles.featureTitle}>Predictable</h3>
                <p>
                  Redux helps you write applications that{' '}
                  <strong>behave consistently</strong>, run in different
              ...
              <div className={classnames('col col--3', styles.feature)}>
                ...
                <h3 className={styles.featureTitle}>Centralized</h3>
                <p>
                  Centralizing your application's state and logic enables
                  powerful capabilities like <strong>undo/redo</strong>,{' '}
              ...
              <div className={classnames('col col--3', styles.feature)}>
                ...
                <h3 className={styles.featureTitle}>Debuggable</h3>
                <p>
                  ...
                  <strong>"time-travel debugging"</strong>, and even send
                  complete error reports to a server.
                </p>
              </div>
              <div className={classnames('col col--3', styles.feature)}>
                <div className="text--center">
                ...
                <p>
                  ...
                  <strong>a large ecosystem of addons</strong> to fit your
                  needs.
                </p>
              </div>
            </div>
          ...
          <div className="container">
            <div className="row">
              <div className="col col--6">
                <h2>Other Libraries from the Redux Team</h2>
                <div>
                  <a href="https://react-redux.js.org">
                    <h3 className={styles.featureAnchor}>
              ...
              <div className="col col--6">
                <h2>Help Us Improve the Redux Docs!</h2>
                <p>
                  We're planning a revamp of the Redux docs content. Please help
                  us make the docs better by{' '}
                  <a href="https://docs.google.com/forms/d/e/1FAIpQLSfzIkY3fXZ8PrQKScYMK0YoEgALfAK2qQ0mOj1_ibKv2qDTuQ/viewform">
                    <strong>filling out this survey</strong>
                  </a>
                  , so we can determine what changes would help the most.
                  Thanks!
                </p>
              </div>
            </div>
