...
const Footer = (props) => {
  ...
  const { baseUrl, footerIcon, title, repoUrl, copyright } = props.config;
  ...
  return (
    <footer className="nav-footer" id="footer">
      <section className="sitemap">
        ...
        <div>
          <h5>Docs</h5>
          <a href={docUrl("introduction/getting-started", undefined, baseUrl)}>
            Getting Started
        </a>
          <a href={docUrl("introduction/core-concepts", undefined, baseUrl)}>
            Core Concepts
        </a>
          <a href={docUrl("basics/basic-tutorial", undefined, baseUrl)}>
            Basics
        </a>
          <a href={docUrl("advanced/advanced-tutorial", undefined, baseUrl)}>
            Advanced
        </a>
        </div>
        <div>
