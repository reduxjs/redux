...
In the [basics guide](../basics/), we built a simple todo application. It was fully synchronous. Every time an action was dispatched, the state was updated immediately.
...
>
> Here, we assume that you understand reducer composition with [`combineReducers()`](../api/combinereducers.md), as described in the [Splitting Reducers](../basics/reducers.md#splitting-reducers) section on the [basics guide](../basics/). If you don't, please [read it first](../basics/reducers.md#splitting-reducers).
