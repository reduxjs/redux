...
export function todos(state: Todo[] = [], action: rootActions) {
  switch (action.type) {
    case ADD_TODO:
      return [
        ...state,
...
export function todosReverse(state: Todo[] = [], action: rootActions) {
  switch (action.type) {
    case ADD_TODO:
      return [
        {
...
export function errorThrowingReducer(state = [], action: rootActions) {
  switch (action.type) {
    case THROW_ERROR:
      throw new Error()
    default:
